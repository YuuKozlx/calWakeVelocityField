...
function y = phi(z, ApBp, r)
    ...
    y(condition3) = Ap(3) * exp(r(3) * (z(condition3) - 0.176)) + Bp(3) * exp(-r(3) * (z(condition2) - 0.176));

    condition4 = (z >= 0.190 & z < 0.202);
    y(condition4) = Ap(4) * exp(r(4) * (z(condition4) - 0.176)) + Bp(4) * exp(-r(4) * (z(condition2) - 0.176));

    condition5 = (z >= 0.202 & z < 0.212);
    y(condition5) = Ap(5) * exp(r(5) * (z(condition5) - 0.176)) + Bp(5) * exp(-r(5) * (z(condition2) - 0.176));

    condition6 = (z >= 0.212 & z < 0.222);
    y(condition6) = Ap(6) * exp(r(6) * (z(condition6) - 0.176)) + Bp(6) * exp(-r(6) * (z(condition2) - 0.176));

    condition7 = (z >= 0.222 & z < 0.232);
    y(condition7) = Ap(7) * exp(r(7) * (z(condition7) - 0.176)) + Bp(7) * exp(-r(7) * (z(condition2) - 0.176));

    condition8 = (z >= 0.232 & z < 0.268);
    y(condition8) = Ap(8) * exp(r(8) * (z(condition8) - 0.176)) + Bp(8) * exp(-r(8) * (z(condition2) - 0.176));

    condition9 = (z >= 0.268 & z < 0.279);
    y(condition9) = Ap(9) * exp(r(9) * (z(condition9) - 0.176)) + Bp(9) * exp(-r(9) * (z(condition2) - 0.176));

    condition10 = (z >= 0.279 & z < 0.289);
    y(condition10) = Ap(10) * exp(r(10) * (z(condition10) - 0.176)) + Bp(10) * exp(-r(10) * (z(condition2) - 0.176));

    condition11 = (z >= 0.289 & z < 0.299);
    y(condition11) = Ap(11) * exp(r(11) * (z(condition11) - 0.176)) + Bp(11) * exp(-r(11) * (z(condition2) - 0.176));

    condition12 = (z >= 0.299 & z < 0.310);
    y(condition12) = Ap(12) * exp(r(12) * (z(condition12) - 0.176)) + Bp(12) * exp(-r(12) * (z(condition2) - 0.176));

    condition13 = (z >= 0.310 & z < 0.325);
    y(condition13) = Ap(13) * exp(r(13) * (z(condition13) - 0.176)) + Bp(13) * exp(-r(13) * (z(condition2) - 0.176));

    condition14 = (z >= 0.325 & z < 0.362);
    y(condition14) = Ap(14) * exp(r(14) * (z(condition14) - 0.176)) + Bp(14) * exp(-r(14) * (z(condition2) - 0.176));

    condition15 = (z >= 0.362 & z < 0.800);
    y(condition15) = Ap(15) * exp(r(15) * (z(condition15) - 0.176)) + Bp(15) * exp(-r(15) * (z(condition2) - 0.176));
